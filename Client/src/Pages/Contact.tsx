...
const Contact = () => {
  return (
    <div className="mx-[10vw] my-[5vh]">
      <h2 className="text-stone-600 text-3xl font-semibold">About us</h2>
      ...
      <h2 className="text-stone-600 text-3xl font-semibold">Our mission</h2>
      <p className="text-stone-500 text-lg mt-5 mb-10">
      ...
      <h2 className="text-stone-600 text-3xl font-semibold mb-5">Contact us</h2>
